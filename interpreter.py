...
class Player:
    ...
    #additional print method for one stat at a time
...
def main(debug=False):
    ...
    saber_model = saber_mm.model_from_file(join(this_folder, 'complexprogram.sbr'))
    model_export(saber_model, join(this_folder, 'complexprogram.dot'))
